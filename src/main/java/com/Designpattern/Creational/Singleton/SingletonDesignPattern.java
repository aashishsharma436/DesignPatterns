...
public class SingletonDesignPattern {
    ...
    4. Implements a mechanism to prevent multiple threads from creating separate instances simultaneously.
    5. Restrict Direct instantiation by making constructor private, forcing the use of access point.

    when to use:
    1. When you need to ensure that only an instance of a class throughout the application.
    ...
    3. If you think, you might want to extend the class later; a singleton pattern is a good choice, It allows
